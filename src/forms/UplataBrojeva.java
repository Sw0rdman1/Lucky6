 ...
 * @author Božidar
 */
public class UplataBrojeva extends javax.swing.JFrame {

    /**
     * Creates new form UplataBrojeva
     */
    public UplataBrojeva() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UplataBrojeva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UplataBrojeva().setVisible(true);
            }
        });
    }
